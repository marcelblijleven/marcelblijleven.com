...
import {BCData, Bean, Brew} from "beanconqueror";
import {HasConfigUUID} from "beanconqueror";
...
export function createMappingByUUID<T extends HasConfigUUID>(data: T[]): Record<string, T> {
...
export function increaseCountOfKey(mapping: Record<string, number>, key: string, value?: number) {
...
export function sortCountMappingDesc(mapping: Record<string, number>): [string, number][] {
