...
import {Bean, Brew, Mill, Preparation} from "beanconqueror";
...
export interface BrewsTableProps {
    ...
    preperationMapping: Record<string, Preparation>;
    limit?: number;
    caption?: string;
}
...
export default function BrewsTable(props: BrewsTableProps) {
    ...
    return (
        <Table className={"whitespace-nowrap"}>
            <TableCaption>{props.caption ? props.caption : getCaption(props.limit ?? 10)}</TableCaption>
            <TableHeader>
                <TableRow>
